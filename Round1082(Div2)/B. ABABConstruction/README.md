...
### Description:
There is a string T of length n, such that T<sub>i</sub>= '`a`' for all odd i and T<sub>i</sub>= '`b`' for all even i.
...
- |A|=n;
- A<sub>i</sub> is either '`a`' or '`b`' for all 1 ≤ i ≤ n;
- A<sub>i</sub> = X<sub>i</sub> for all 1 ≤ i ≤ n such that X<sub>i</sub> is not '`?`';
