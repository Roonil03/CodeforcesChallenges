...
```
**Explaination:**  
In the first example, without using AI, Nikita and Maxim will write 2
 lines of code in 1
 hour, and since the project requires only 1
 line to finish, it will be completed in 1
 hour.

In the fourth example, Nikita spends the first hour setting up the AI, while Maxim writes 10
 lines during that time, and then during the next hour 10+9⋅10=100
 lines of code are written, so the whole project can be completed in 2
 hours.